            ...
            <div class="columns is-multiline">
                ...
                <div class="column is-6">
                    <div class="field">
                        ...
                        <div class="control">
                            <label class="radio">
                                <input type="radio" name="is_active" value="1" <?php echo $product->is_active ? 'checked' : ''; ?>> 
                                Activo
                            </label>
                            <label class="radio">
                                <input type="radio" name="is_active" value="0" <?php echo !$product->is_active ? 'checked' : ''; ?>> 
                                Descontinuado
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="box has-text-centered" style="background-color: #fafafa;">
                            <?php if ($product->image_prod): ?>
                                ...
                                <p class="help">
                                    <a href="#" onclick="return false;" style="color: red;">
