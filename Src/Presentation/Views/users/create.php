                ...
                <form action="<?php echo $_ENV['APP_URL']; ?>/users/store" method="POST" id="userForm">
                        <div class="columns is-multiline">
                                ...
                                <div class="column is-6" id="employeeField" style="display: none;">
                                        <div class="field">
                                                <label class="label">
                                                        <i class="fas fa-user-tie"></i> Empleado Asociado<span class="has-text-danger">*</span>
                                                </label>
                                                <div class="control">
                                                        <div class="select is-fullwidth">
                                                ...
                                                <p class="help">Obligatorio para usuarios Admin y Employee</p>
                                        </div>
                                </div>
...
<script>
        ...
        document.getElementById('role').addEventListener('change', function() {
                ...
                if (role === 'Employee') {
                        ...
                        document.querySelector('select[name="employee_id"]').required = true;
                        // Si es Admin, el campo customer_id debe ser NULL...
                        if (document.querySelector('select[name="customer_id"]')) {
                        ...
                        // Si es Customer, el campo employee_id debe ser NULL...
                        if (document.querySelector('select[name="employee_id"]')) {
